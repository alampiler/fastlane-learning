...
- [x] Один flow (відкрити апку → натиснути кнопку → перевірити текст) — спершу локально
- [x] Той самий flow в CI на Android-емуляторі (`reactivecircus/android-emulator-runner`)
